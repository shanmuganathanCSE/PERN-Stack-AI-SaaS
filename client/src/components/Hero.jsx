  ...
  return (
    ...
    bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'> 
      ...
      <div className='text-center mb-6'>
        ...
        <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-l m-auto max-sm:text-xs text-gray-600'>Transform your content creation with our suite of premium AI tools.
